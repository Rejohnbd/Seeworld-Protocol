...
exports.protocol = "S5E";
exports.model_name = "S5E";
// exports.compatible_hardware = ["S5E/supplier"];
  ...
  this.parse_data = function (data) {
    ...
    if (parts["start"] == "7878") {
      ...
      if (parts["protocal_id"] == "01") {
        ...
        console.log("when protocal_id 13 meanut status information");
        //console.log("Device Status",data.substr(8,2));
        (parts["status"] = data.substr(8, 2)), (parts["device_id"] = "");
        parts.cmd = "heartbeat";
        parts.action = "heartbeat";
      } else if (parts["protocal_id"] == "15") {
        console.log("when protocal_id 15 means String information");
        parts["device_id"] = "";
        parts["data"] = data.substr(8, parts["length"] * 2);
        parts.cmd = "alert";
        parts.action = "alert";
      } else if (parts["protocal_id"] == "16") {
        console.log("when protocal_id 16 means Alerm data");
      } else if (parts["protocal_id"] == "80") {
        console.log(
          "when protocal_id 80 means Command information sent by the server to the terminal"
        );
      } else {
        console.log("no protocol id else");
        parts["device_id"] = "";
        parts.cmd = "noop";
        parts.action = "noop";
      }
